  ...
  <div class="admin-content">
    ...
    <div class="am-g">
              ...
              <div class="am-u-md-6">
                <form class="am-form" action="UploadHandleServlet" enctype="multipart/form-data" method="post">
                  <div class="am-form-group">
                    <input type="file" id="user-pic" name="picture">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        ...
        <form class="am-form am-form-horizontal" action="UserServlet1" method="post">
          <font class="am-u-sm-9"><%=mess.getMess() %> </font><br> 
          
        <input type="hidden" value="<%=jiebao.getId()%>" name="id" />
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">呢称 / NickName</label>
            <div class="am-u-sm-9">
              <input type="text" id="user-name" name="name" value=<%=jiebao.getName() %>>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-sex" name="sex" value=<%=jiebao.getSex() %>>
              <small></small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="date" id="user-birthday" name="birthday" value=<%=jiebao.getBirthday() %>>
              <small></small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-address" name="address" value=<%=jiebao.getAddress() %>>
              <small></small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-autograph" name="autograph" value="">
              <small></small>
            </div>
          </div>
          -->
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="email" id="user-email" name="email" value=<%=jiebao.getEmail()%>>
              <small>邮箱你懂得...</small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-MSN" name="MSN" value=<%=jiebao.getMsn() %>>
              <small></small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-QQ" name="QQ" value=<%=jiebao.getQq()%>>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-phone" name="phone" value=<%=jiebao.getPhone() %>>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-occupation" name="occupation" value=<%=jiebao.getOccupation() %>>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-worklife" name="worklife" value=<%=jiebao.getWorklife() %>>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-state" name="state" value=<%=jiebao.getSate() %>>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-workunit" name="workunit" value=<%=jiebao.getWorkunit() %>>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-platform" name="platform" value=<%=jiebao.getPlatform() %>>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="user-intro" name="intro"><%=jiebao.getExpertise()%></textarea>
