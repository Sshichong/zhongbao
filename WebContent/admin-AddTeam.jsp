  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="AddTeamServlet"  method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">团队名称 / TeamName</label>
            <div class="am-u-sm-9">
              <input type="text" id="TeamName" name="TeamName" placeholder="团队名称 / TeamName">
...
<div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="CaptainName" name="CaptainName" placeholder="队长名称 / CaptainName">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="MemberName" name="MemberName" placeholder="队员名称 / MemberName">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="ProjectName" name="ProjectName" placeholder="参加项目 / ProjectName">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="Introduction" name="Introduction" placeholder="团队简介 / Introduction"></textarea>
